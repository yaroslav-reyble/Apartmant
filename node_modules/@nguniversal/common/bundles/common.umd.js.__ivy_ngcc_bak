(function (global, factory) {
    ...
    var TransferHttpCacheInterceptor = /** @class */ (function () {
        ...
        TransferHttpCacheInterceptor = tslib.__decorate([
            core.Injectable(),
            tslib.__metadata("design:paramtypes", [core.ApplicationRef, platformBrowser.TransferState])
    ...
    var TransferHttpCacheModule = /** @class */ (function () {
        ...
        TransferHttpCacheModule = tslib.__decorate([
            core.NgModule({
    ...
    var StateTransferInitializerModule = /** @class */ (function () {
        ...
        StateTransferInitializerModule = tslib.__decorate([
            core.NgModule({
                providers: [
